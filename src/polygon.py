...
class Polygon():
    def __init__(self, pos, length, height, space, mass=5.0):
        ...
        wood = pygame.image.load("D:/python/PycharmProjects/ty/theAngryBirds/resources/images/wood.png").convert_alpha()
        wood2 = pygame.image.load("D:/python/PycharmProjects/ty/theAngryBirds/resources/images/wood2.png").convert_alpha()
